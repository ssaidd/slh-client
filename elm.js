...
var author$project$Rest$getWithCors = F2(
...
var author$project$Types$Track = F4(
	function (title, artists, album, albumImgUrl) {
		return {album: album, albumImgUrl: albumImgUrl, artists: artists, title: title};
	});
var elm$json$Json$Decode$list = _Json_decodeList;
var elm$json$Json$Decode$string = _Json_decodeString;
var elm$json$Json$Decode$succeed = _Json_succeed;
var author$project$Rest$trackDecoder = A3(
	...
	A3(
		...
		A3(
			...
			A3(
				...
				'name',
				elm$json$Json$Decode$string,
				elm$json$Json$Decode$succeed(author$project$Types$Track)))));
var author$project$Types$TrackWithPlayedAt = F2(
	function (track, playedAt) {
		return {playedAt: playedAt, track: track};
	});
var author$project$Rest$trackWithPlayedAtDecoder = A3(
	NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
	'playedAt',
	elm$json$Json$Decode$string,
	A3(
		NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
		'trackData',
		author$project$Rest$trackDecoder,
		elm$json$Json$Decode$succeed(author$project$Types$TrackWithPlayedAt)));
var author$project$Rest$historyDecoder = A2(
	elm$json$Json$Decode$field,
	'content',
	elm$json$Json$Decode$list(author$project$Rest$trackWithPlayedAtDecoder));
...
var author$project$Rest$toHistoryUrl = function () {
...
var author$project$Rest$getHistoryCommand = A2(
	elm$core$Platform$Cmd$map,
	author$project$Types$ReceivedHistory,
	krisajenkins$remotedata$RemoteData$sendRequest(
		A2(author$project$Rest$getWithCors, author$project$Rest$toHistoryUrl, author$project$Rest$historyDecoder)));
var author$project$Types$ReceivedTimeZone = function (a) {
	return {$: 'ReceivedTimeZone', a: a};
};
...
var author$project$State$getTimeZone = A2(elm$core$Task$perform, author$project$Types$ReceivedTimeZone, elm$time$Time$here);
var elm$core$Platform$Cmd$batch = _Platform_batch;
var elm$time$Time$utc = A2(elm$time$Time$Zone, 0, _List_Nil);
var krisajenkins$remotedata$RemoteData$Loading = {$: 'Loading'};
var author$project$State$init = function (_n0) {
	return _Utils_Tuple2(
		{history: krisajenkins$remotedata$RemoteData$Loading, timeZone: elm$time$Time$utc},
		elm$core$Platform$Cmd$batch(
			_List_fromArray(
				[author$project$Rest$getHistoryCommand, author$project$State$getTimeZone])));
};
		...
		switch (msg.$) {
			case 'GetHistory':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{history: krisajenkins$remotedata$RemoteData$Loading}),
					author$project$Rest$getHistoryCommand);
...
var author$project$View$createErrorMessage = function (httpError) {
	switch (httpError.$) {
		case 'BadUrl':
		...
		case 'NetworkError':
			return 'Failed to retrieve history from server.';
		case 'BadStatus':
...
var author$project$View$toString = F2(
	function (timeZone, time) {
		if (time.$ === 'Ok') {
			var posixTime = time.a;
			var partOfTime = function (toPart) {
				return A3(
					elm$core$String$padLeft,
					2,
					_Utils_chr('0'),
					elm$core$String$fromInt(
						A2(toPart, timeZone, posixTime)));
			};
			var monthToString = function () {
				var _n1 = A2(elm$time$Time$toMonth, timeZone, posixTime);
				switch (_n1.$) {
					case 'Jan':
						return '01';
					case 'Feb':
			...
			return partOfTime(elm$time$Time$toDay) + ('-' + (monthToString + ('-' + (partOfTime(elm$time$Time$toYear) + (' ' + (partOfTime(elm$time$Time$toHour) + (':' + partOfTime(elm$time$Time$toMinute))))))));
		} else {
			return 'Error parsing time stamp';
		}
	});
...
var author$project$View$adjustTime = F2(
	function (timeZone, timeString) {
		var regex = A2(
			elm$core$Maybe$withDefault,
			elm$regex$Regex$never,
			elm$regex$Regex$fromString('\\.000\\+0000$'));
		return A2(
			author$project$View$toString,
			timeZone,
...
var author$project$View$viewTrackWithPlayedAt = F2(
	function (timeZone, _n0) {
		var track = _n0.track;
		var playedAt = _n0.playedAt;
		return A2(
			elm$html$Html$tr,
			_List_Nil,
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									elm$html$Html$Attributes$src(track.albumImgUrl),
					...
					_List_fromArray(
						[
							elm$html$Html$text(
							A2(elm$core$String$join, ', ', track.artists))
						])),
					A2(
					elm$html$Html$td,
					_List_Nil,
...
var author$project$View$viewHistoryOrError = function (model) {
	...
	switch (_n0.$) {
		...
		case 'Success':
			var history = _n0.a;
			return A2(author$project$View$viewHistory, model.timeZone, history);
		default:
			var httpError = _n0.a;
			return elm$html$Html$text(
				author$project$View$createErrorMessage(httpError));
	}
};
...
var author$project$App$main = elm$browser$Browser$element(
	{init: author$project$State$init, subscriptions: author$project$State$subscriptions, update: author$project$State$update, view: author$project$View$root});
